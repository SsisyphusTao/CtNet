...
class CenterNet_MobileNetV2(nn.Module):
    def __init__(self, n_class=21, input_size=300, width_mult=1., dropout_ratio=0.2,
                 use_batch_norm=True, onnx_compatible=False):
        super(CenterNet_MobileNetV2, self).__init__()
