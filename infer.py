...
if __name__ == "__main__":
  ...
  #         for k,v in torch.load('checkpoints/ctnet_dla_20_672.pth').items()})
  load_model(net, 'ctdet_coco_dla_2x.pth')
  # torch.save(net.state_dict(), 'pretrain_dla.pth')
  net.eval()

  #%%
  img = cv.imread('/ai/ailab/User/huangtao/Panoptic/image2.jpg')
  ...
  for i in dets:
    for j in dets[i]:
      if j[-1] > 0.2:
        cv.rectangle(img, (j[0], j[1]), (j[2], j[3]), 255, 1)
        print(i)
